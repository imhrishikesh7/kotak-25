    ...
    <div className="bg-[#f4f8fd] p-6 md:p-10 rounded-3xl  mx-auto">
      ...
      <div className="bg-[#e3f1fd] p-5 rounded-3xl space-y-4 mb-5">
        ...
        <p className="text-lg leading-relaxed text-[#333]">
          The Bank had received an order dated 24th April, 2024
          (‘Order’) from the RBI, inter alia, directing the Bank
          to cease and desist, with effect from 24th April, 2024,
          from on-boarding new customers through the Bank’s
          online and mobile banking channels and issuing fresh
          credit cards. The Order was based, inter alia, on the
          deficiencies observed by the RBI in the Information
      ...
      <div className="flex flex-col md:flex-row gap-8">
        <div className="flex-1 space-y-6">
          ...
          <div className="bg-[#e3f1fd] p-5 rounded-3xl space-y-4">
            ...
            <p className="text-lg leading-relaxed text-[#333] mb-3">
              ...
              assessments were completed against the RBI Master
            ...
            <p className="text-lg leading-relaxed text-[#333] mb-3">
              ...
              strong culture of cybersecurity across the organisation.
            </p>
            <p className="text-lg leading-relaxed text-[#333]">
        ...
        <div className="flex-1 space-y-6">
          ...
          <div className="bg-[#e3f1fd] p-5 rounded-3xl space-y-4">
            ...
            <p className="text-lg leading-relaxed text-[#333]">
              The RBI, vide its letter dated 12th February, 2025,
              communicated its decision to the Bank to lift the
              aforementioned restrictions placed on the Bank, having
              satisfied itself of the remedial measures undertaken by the
              Bank to address the supervisory concerns and the submission
              of compliances made to it (including the report of the
              external Auditor).
            </p>
            <img
