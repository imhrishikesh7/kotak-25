        ...
        <div className='bg-[#F2F2F2]/50 pt-8'>
            <div className='marginal'>
                <div className='w-full  mx-auto text-center'>
                    ...
                    <Reveal animation="slide-up" className={"text-lg my-4 leading-6 w-full"}>
                        <p>
                ...
                <div className='gap-4  flex-col'>
                    <div className='flex w-full flex-col justify-center items-cente'>
                        <Reveal animation="slide-up">
                            <p className='text-4xl mx-auto w-full font-thin text-center'>
