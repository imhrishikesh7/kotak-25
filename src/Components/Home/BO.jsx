  ...
  return (
    <div className="bg-gradient-to-br from-slate-50 via-white to-slate-100">
      ...
      {isModalOpen && selectedCard && (
        <div 
          ref={overlayRef}
          className={`fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center p-4 sm:p-6 z-50 transition-all duration-300 ${
        ...
        >
          <div
            ref={modalRef}
            className={`bg-white rounded-2xl max-w-5xl w-full max-h-[90vh] overflow-hidden shadow-2xl mx-4 transition-all duration-300 ${
              isModalVisible 
