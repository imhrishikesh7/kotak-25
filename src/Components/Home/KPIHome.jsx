...
const chartImages = {
    'Operational Metrics': [
        './charts/c11.webp', './charts/c12.webp', './charts/c13.webp',
        './charts/c14.webp', './charts/c15.webp', './charts/c16.webp',
        './charts/c17.webp', './charts/c18.webp', './charts/c19.webp',
        './charts/c110.webp', './charts/c111.webp', './charts/c112.webp',
    ],
    'Group Company Metrics': [
        './charts/c21.webp', './charts/c22.webp', './charts/c23.webp',
        './charts/c24.webp', './charts/c25.webp', './charts/c26.webp',
        './charts/kc1.webp', './charts/kc2.webp'
    ],
    'Valuation Metrics': [
        './charts/c31.webp', './charts/c32.webp', './charts/kc3.webp',
        './charts/kc4.webp', './charts/kc5.webp',
    ],
};

const Arrow = ({ onClick, direction }) => (
    <div
        className={`absolute bottom-4 ${direction === 'left' ? 'right-16' : 'right-4'} cursor-pointer bg-gradient-to-br from-[#9f0910] to-[#ed1c25] text-white w-8 h-8 flex items-center justify-center rounded-full`}
        onClick={onClick}
    >
        {direction === 'left' ? <HiOutlineArrowSmallLeft /> : <HiOutlineArrowSmallRight />}
    </div>
);
...
const KPIHome = () => {
    ...
    // Reset slider to first slide on tab change
    useEffect(() => {
            ...
            <div className="relative bg-white rounded-2xl p-6 md:h-[450px] overflow-hidden max-w-5xl mx-auto">
                <Slider ref={sliderRef} {...sliderSettings}>
                    {chartImages[activeTab].map((src, index) => (
                        <div key={index}>
                            <div className="overflow-hidden" ref={(el) => (imageRefs.current[index] = el)}>
                        ...
                        <div className='flex items-start gap-1'>
                            ...
                            <p className="text-xs gap-1">
                                ...
                                **Computed based on the principles prescribed by APS10. The methodology, assumptions and results have been reviewed by Willis Towers Watson Actuarial Advisory LLP |
                                <sup>#</sup>Average Assets Under Management | <sup>##</sup>excluding Proprietary Segments
                            </p>
                        </div>
                    )}
                </div>
