    ...
    return (
        ...
        <div className='marginal '>
            <div className='w-fit mx-auto  text-center'>
                ...
                <Reveal animation="slide-up">
                    <h1 className="text-5xl pb-2 font-light text-transparent bg-gradient-to-r from-[#ed1c25] to-[#013367] bg-clip-text">Responsible growth, resilient performance</h1>
                </Reveal>
            </div>
            <div className="bg-[#ffff] my-12 mx-auto rounded-xl p-6 w-full max-w-xl">
