...
const Technology = () => {
  ...
  return (
    <div>
      ...
      {/* Animated Section */}
      <div className="h-[70vh] my-12" ref={sectionRef}>
        <div className="flex md:flex-row flex-col h-full items-center gap-4 margina">
          {/* Gradient Panel */}
          <div
            ref={gradientRef}
            className="md:w-[50%] flex flex-col justify-center rounded-r-4xl h-full bg-gradient-to-br from-[#ed1c25] to-[#013367] px-12"
          >
