...
export default function VCModel() {
        ...
        <div className="min-h-screen bg-white  px-4">
            <div className="marginal mx-auto">
                <div className='w-fit mb-12 mx-auto text-center'>
                    ...
                    <Reveal animation="slide-up">
                        <h1 className="text-5xl pb-2 font-light text-transparent bg-gradient-to-r from-[#ed1c25] to-[#013367] bg-clip-text">Perceiving value through the 4C framework</h1>
                    </Reveal>
                </div>
    ...
    `}
                    ...
                    >
                        ...
                        >
                            <img src="./home/vcmodel.jpg" className='h-full rounded-3xl' alt="" />
                        </div>
                    </div>
