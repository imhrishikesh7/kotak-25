...
const Navbar = () => {
  ...
  return (
    <div className=" z-50 sticky top-0">
      <nav className="bg-[#013367]  relative text-white md:px-16 px-6 py-6 flex justify-between items-center">
      ...
      <div
        ref={mobileRef}
        className={`fixed top-0 right-0 w-full h-screen bg-[#013367] text-white p-6 md:hidden overflow-hidden ${
          mobileOpen ? "" : "hidden"
        }`}
      >
