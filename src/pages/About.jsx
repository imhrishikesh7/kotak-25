    ...
    return (
        <div className="marginal">
            <div className="mb-4">
                ...
                <p className="text-lg text-[#000000] mt-10">
                ...
                <div className="text-md text-[#000000] mt-8 border-t pt-4 italic">
                    <p>
            ...
            <div className='mt-10 flex flex-col md:flex-row gap-10'>
                <div className='md:w-3/4 mx-auto'>
                    <h2 className="text-xl font-semibold text-[#ed1c2f] mb-4">Orchestrating Cohesive User Experiences Across Multiple Platforms</h2>
                    <p className="text-lg text-[#000000]">
                        ...
                        <br />
                        <br />While we will explore our digital footprint in greater detail later, it is worth
                    ...
                    <h1 className='text-xl font-semibold text-[#ed1c2f] mb-4 mt-10'>Physical Footprint</h1>
                    <p className='text-lg text-[#000000]'>
