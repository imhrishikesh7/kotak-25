    ...
    <div className='marginal text-lg'>
      ...
      <div className='mb-5 mt-5'>
        ...
        <div className=''>
          ...
          <h1 className='text-xl text-[#13206b] font-semibold'>
      ...
      <div className='mb-5 text-sm text-gray-700 border-t-1 pt-2'>
      ...
      <div className='mb-5 mt-10'>
        ...
        <div className='mb-5  p-4 bg-gray-100 rounded-4xl'>
          <img className='w-[80%] mx-auto' src="\Delivery_Excellence\Image-64.png" alt="" />
        </div>
      </div>
      <div className='mb-5'>
      ...
      <div className='flex md:flex-row flex-col gap-5'>
        <div className='md:w-[31.5%] mx-auto'>
      ...
      <div className='mt-5 mb-5'>
        ...
        <div className=''>
          ...
          <p className='mb-2'>
            ...
            the Bank’s overall security posture and operates under a Boardsanctioned policy framework, which is reviewed annually.
        ...
        <div>
          ...
          <p className=''>
            ...
            management and alerting system, enabling proactive servicelevel monitoring, rapid incident detection and swift resolution.
            <br />
            <br />
      ...
      <div className='bg-gray-100 p-4'>
        <img src="\Delivery_Excellence\Image-67.png" alt="" className='rounded-3xl w-[70%] mx-auto' />
      </div>
    </div>
  )
}
