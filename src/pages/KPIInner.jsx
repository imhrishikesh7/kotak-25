...
const KPIHome = () => {
    ...
    return (
        <div className=" overflow-hidden py-10 px-4 marginal">
            <div className='w-fit md:block hidden mx-auto mb-6 text-center'>
            ...
            <div className='block md:hidden mb-6 mt-4'>
                ...
                <h3 className="text-2xl mb-2 text-center font-bold text-[#ed1c25]">Key Performance Indicators</h3>

                <div className='flex w-[50px] mb-2 mx-auto'>
                    <div className='h-[2px] bg-[#ed1c25] w-1/2 mx-auto' />
                    <div className='h-[2px] bg-[#013367] w-1/2 mx-auto' />
                </div>

                <h1 className="text-3xl text-center md:text-5xl pb-2 font-light text-transparent bg-gradient-to-r from-[#ed1c25] to-[#013367] bg-clip-text">Responsible growth, resilient performance</h1>

                <p className='text-lg  leading-6 w-7xl'>
                    All numbers are on a consolidated basis except where stated
                </p>
                </div>
            {/* Tabs */}
