      ...
      <div className='mt-5 mb-5'>
        ...
        <div className='md:flex gap-5'>
          <div className='md:w-[50%] '>
            ...
            <p className='mb-2'>
              The Enterprise-wide Risk Management (ERM) framework provides a unified and integrated approach
              to managing risks, enabling the group to balance risk and return while driving long-term
              sustainability, shareholder value creation and financial strength. The framework also supports
              delivery of customer-centric products and services. The ERM policy, which guides the ERM
              framework, forms the basis for risk management across the group, with tailored modifications for
              individual businesses. A suite of policies and procedures supports this framework, providing clear
              guidelines for managing specific risks and aligning risk mitigation with business objectives. By
              integrating risk management into our core operations, we ensure a balanced approach that
              maximises opportunities while minimising potential losses. Refer to ‘Management’s Discussion and
              Analysis’ section of the report on page <strong className='text-[#212b7e]'>444</strong> for further details on ERM framework.
            </p>
            <p className='mb-2'>
              The Group Chief Risk Officer (CRO), appointed by the Board, reports directly to the MD & CEO and
              heads the independent risk function in the Bank. The risk management team comprises of several
              units, that are responsible for managing different kinds of risk and report to the CRO. Detailed
              reports related to the performance in relation to risk appetite are presented by the CRO to the Board
              and its Risk Management Committee (RMC) on a quarterly basis. The RMC and the Board are
              professionally qualified to discharge their responsibilities, equipped with deep industry knowledge,
              skills, experience, professional qualifications and relevant technical as well as financial acumen in
              risk and related disciplines.
            </p>
            <p className='mb-2'>
              Our Bank has implemented the Three Lines of Defence model for risk management, establishing a
              robust and transparent governance framework that includes active involvement of both the Board
              and senior management. This framework ensures a unified understanding of risk across the
              organisation, promoting a collaborative approach to risk identification, assessment and mitigation.
            </p>
          </div>
        ...
        <div className=''>
          ...
          <p className='mb-2'>
            Our Group conducts Internal Capital Adequacy Assessment Process (ICAAP) analysis annually. This
            provides a comprehensive view of overall risks and assesses the capital required to mitigate them. The
            ICAAP findings are reviewed by senior management and approved by the Board. There are two critical
            components of risk management - Risk appetite framework and Stress testing.
          </p>
          <div className='mb-2'>
            <ul className='list-disc ml-6 marker:text-red-600'>
              ...
              <li className='mb-2'>
                Stress testing strengthens our predictive risk management by estimating tail risks and determining
        ...
        <div className='mb-5 mt-10'>
          ...
          <p className='mb-2'>
            The banking sector has an array of emerging risks encompassing cybersecurity threats, technological
            disruptions and climate-related financial vulnerabilities. To effectively mitigate these risks, our Bank is
            developing a proactive and adaptable risk management approach, complemented by a forward-thinking
            strategy to foster resilience and sustainable value creation.
          </p>
          <div className='mb-4'>
            ...
            <p className='mb-2'>
              Data privacy and cybersecurity risk is the risk of financial loss, disruption of business operations or
              damage to our reputation resulting from failures or inadequacies in technology systems, data breaches
            ...
            <div className='md:flex gap-5'>
              <div className='md:w-[65%]'>
                ...
                <p className='mb-2'>
                  The Data Privacy Policy governs the overall management including handling of personally identifiable
                  information of customers and incorporates the principles for collection, use, retention, transfer,
                  disclosure and destruction of any personal data belonging to customers of the Bank. Various initiatives
                  undertaken to ensure data privacy include advanced security infrastructure, prompt incident response
                  and recovery mechanisms, employee training and awareness, for data handling to ensure strict
                  compliance and monitoring. The Bank has initiated assessment and implementation under the Digital
                  Personal Data Protection Act (DPDPA), 2023. We have a Data Privacy Office within the Risk Management
                  Unit to handle Privacy related matters and relevant initiatives.
                </p>
                <p className='mb-2'>
                  Sophisticated actors continuously probe financial institutions for vulnerabilities. To protect ourselves
                  against cybersecurity risks, we have invested significant efforts in automated patch management,
                  multi-factor authentication and encryption protection against known attack vectors. We also continue
                  with behavioral monitoring which helps us identify novel threats.
                </p>
              </div>
          ...
          <div className='mb-4'>
            ...
            <div className='md:flex gap-5'>
              ...
              <div className='md:w-[70%]'>
                <p className='mb-2'>
                  Technology simultaneously represents our greatest opportunity and the most complex risk. As banking
                  becomes increasingly digital, traditional risk boundaries blur, creating interconnected vulnerabilities
                  requiring holistic management approaches. Our strategy acknowledges this complexity while
                  maintaining focus on fundamental risk principles.
                </p>
                <p className='mb-2'>
                  The pace of technological change accelerates annually — systems considered cutting-edge today may
                  become obsolete tomorrow. This reality shapes our investment philosophy as we focus on building
                  flexible, scalable architectures capable of evolving rather than rigid systems requiring wholesale
                  replacement. We emulate this philosophy in dealing with the various core technology risks and the risks
                  that arise due to rapid technology evolution. Detailed explanation on technology advancements can be
                  found ‘Digital Powerhouse’ section of the report on pages <strong className='text-[#212b7e]'>24-25</strong>.
                </p>
              </div>
              <div></div>
            </div>
        ...
        <div className='mb-5'>
          <p className='mb-2'>
            Technology risks can be further detailed into two below domains i.e. core technology risks and risks
        ...
        <div className='mb-5 md:flex gap-5'>
          <div className=''>
            <p className='mb-2'>
              Technology risk management must anticipate rather than react. Scenario planning exercises explore
              potential futures - from quantum computing's impact on encryption to AI regulation's effect on business
              models. This forward-looking approach ensures preparedness for multiple potential outcomes.
            </p>
            <p className='mb-2'>
              While significant progress was made by us in FY 2024-25, technology risk remains dynamic. Continued
              investments in resilience, automation and security capabilities position us to navigate future challenges
              while capitalising on emerging opportunities. Our commitment extends beyond risk mitigation to
              risk-informed innovation, ensuring technology serves as an enabler of sustainable growth.
            </p>
          </div>
        ...
        <div className='mb-4 mt-5'>
          ...
          <div className='md:flex gap-5'>
            ...
            <div className='md:w-[85%]'>
              <p className='mb-2'>
                ESG (Environmental, Social and Governance) risk is the risk associated with environmental issues (such
                as pollution, improper industrial discharge, loss of biodiversity etc.), social issues (such as
                occupational safety, social unrest etc.) and/or issues related to poor governance. This risk may be
                associated with the borrowers in our portfolio or related to our own operations.
              </p>
              <p className='mb-2'>
                Climate risk is the risk of financial loss due to climate change. This includes physical risk which arises
                from the impact of climate events on portfolio and operations (such as natural calamities or gradual
                changes in climate conditions), and transition risk which arises from the transition towards a low-carbon
                economy (such as carbon tax or renewable energy costs).
              </p>
            </div>
          </div>
        </div>
        <div className='mb-5'>
          ...
          <p className='mb-2'>
            A dedicated ESG function within our Bank focuses on addressing ESG and climate risks. The Heads of CSR
            and ESG and the Head of Sustainability hold direct accountability and a Whole Time Director provides
            oversight and guides this function. This function works closely with business units to ensure that best
            practices in environmental and social responsibility are integrated into the services we provide. We also use
            ratings as a tool to understand the ESG risks faced by the Bank and use the analysis to address these risks.
            Details on how we address ESG risk in our lending portfolio is available under ‘Advancing ESG in our Core
            Businesses’ on page <strong className='text-[#212b7e]'>80</strong> of Embracing Sustainability.
          </p>
          <p className='mb-2'>
            Considering the escalating threat of climate-related risks to the broader economy, we undertook a
            forward-looking, scenario-based assessment of climate risk and opportunities in FY 2022-23 and FY
            2023-24, in alignment with global guidelines. We have employed a two-pronged approach to understand
            the potential climate-related risks that may impact our operations and portfolio.
          </p>
        </div>
        <div className='mb-5'>
          <div className='bg-[#f8f8f8] p-5 rounded-2xl border border-gray-200 shadow-sm '>
            <div className='flex items-start gap-4'>
              ...
              <div>
                ...
                <p className='mb-2'>
                  We conducted a physical risk assessment for our operations in FY 2022-23, which indicated that
                  estimated annual financial impacts were within the Bank operational risk appetite. Leveraging the
                  findings from the assessment, we established guidelines covering governance, oversight, assessment
                  frequency and internal roles and responsibilities as well as data collation practices and proposed
                  mitigation measures such as business continuity planning. This assessment is conducted on a periodic
                  basis.
                </p>
              </div>
            </div>
          ...
          <div className='bg-[#f8f8f8] p-5 rounded-2xl border border-gray-200 shadow-sm '>
            <div className='flex items-start gap-4'>
              ...
              <div>
                ...
                <p className='mb-2'>
                  To identify transition risks in the Bank’s corporate lending portfolio, we are adopting a sectoral
                  approach, analysing two scenarios informed by global guidelines and India’s net zero commitments.
                  The focus sectors include Power Generation (FY 2022-23) and Cement Manufacturing (FY 2023-24).
                  These ongoing climate risk assessments have given insight into portfolio emissions, data challenges
                  and emerging sectoral technologies. As this is an evolving process, we are proactively addressing
                  challenges, monitoring emerging developments and refining our methodologies to enhance reliability of
        ...
        <div className='mb-5 md:flex gap-5'>
          ...
          <div className='md:w-[70%] '>
            <p className='mb-2'>
              We are in the process of drafting a comprehensive Climate Change Policy, outlining guidelines for
              assessing climate risks across our Bank’s operations and portfolio. This policy is proposed to align with
              the key areas to be specified in the Reserve Bank of India’s (RBI) expected guidelines on climate-related
              financial disclosures.
            </p>
            <p className='mb-2'>
              The RBI framework encourages the regulated entities to take proactive steps in reducing their carbon
              footprint in addition to disclosure of their climate-related exposures. In line with this directive, we are
              undertaking efforts to develop a decarbonisation strategy. Further details on this are available in
              Embracing sustainability section pages <strong className='text-[#212b7e]'>78-97</strong>.
            </p>
            <p className='mb-2'>
              The advent of climate change presents both risks and opportunities for financial institutions. While it
              poses significant challenges that require immediate attention, it also creates a compelling business case
              for banks to play a pivotal role in financing the transition to a low-carbon economy. We are poised to
              capitalise on the growing demand for climate-resilient investments and infrastructure projects through
              financing opportunities such as renewable energy, green buildings, electric vehicles and advanced battery
              storage solutions. Some of the steps taken by the Bank towards these opportunities is available in
              Embracing Sustainability pages <strong className='text-[#212b7e]'>78-97</strong>.
            </p>
          </div>
        </div>
        <div className='mb-5 md:flex gap-5'>
          <div className='md:w-[70%]'>
            ...
            <div>
              <p className='mb-2'>
                Our risk governance model is reinforced by a strong risk culture, empowering all employees to understand
                and manage risks in line with their roles and responsibilities. We prioritise responsible business
                practices, customer needs and transparency through our risk culture framework. This approach
                reinforces high level of risk awareness across our organisation, integrating risk management into
                decision-making processes. Employees are constantly engaged through risk related communication as
                well as tailored training programmes. In FY 2024-25, we conducted specialised risk management trainings
                of amounting to ~500 hours for employees in the risk team, in association with prestigious institutions
                such as the RBI, NIBM (National Institute of Bank Management) and FEDAI (Foreign Exchange Dealers'
                Association of India). Around 3 lakh hours of risk-related training has been imparted to employees across
                the Bank. For further details, please refer to ‘Management’s Discussion and Analysis’ section of the
                report on pages <strong className='text-[#212b7e]'>444-455</strong>.
              </p>
              <p className='mb-2'>
                Compliance with risk management policies and protocols is a part of Kotak’s DNA and all employees are
                expected to abide by these protocols. Continuous adherence checks are ensured for highest level of
                safety and compliance to risk policies. Risk management is made part of the annual performance
                appraisals for employees to foster accountability and encourage responsible decision-making.
              </p>
            </div>
          </div>
          <div className='md:w-[30%] '>
