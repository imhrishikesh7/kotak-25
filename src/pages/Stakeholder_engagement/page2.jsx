    ...
    <div className='marginal'>
      ...
      <div className='md:flex gap-5 mb-3 pb-3 border-b-2 border-[#b6b8ba]'>
        ...
        <div className='flex items-center'>
          <img src="Stakeholders\Box-Page-31.png" alt="" />
        </div>
      ...
      <div className='mb-5'>
        <img src="Stakeholders\IMG_6426.jpg" alt="" className='rounded-3xl' />
      </div>
      <div className='text-lg'>
        ...
        <div className='flex lg:flex-row flex-col gap-5'>
          <div className='lg:w-1/3'>
            <img src="Stakeholders\Image-32-Box1.png" alt="" />
          </div>
          <div className='lg:w-1/3'>
            <img src="Stakeholders\Image-32-Box2.png" alt="" />
          </div>
          <div className='lg:w-1/3'>
            <img src="Stakeholders\Image-32-Box3.png" alt="" />
          </div>
        </div>
      </div>
      ...
      <div className='text-lg md:flex gap-5 mb-6'>
        ...
        <div className='md:w-[50%] mt-5'>
          <img src="Stakeholders\IMG_6561.jpg" alt="" className='rounded-3xl' />
        </div>
      </div>
      <div className='mb-5'>
